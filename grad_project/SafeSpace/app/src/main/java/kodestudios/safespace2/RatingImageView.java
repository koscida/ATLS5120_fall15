    ...
    private static class UrlLoadingTask extends AsyncTask<URL, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject result) {
            if (!this.isCancelled) {
                ...
                switch(r) {
                    case -1:
                    case 0: this.updateView.setImageResource(R.drawable.rating_0); break;
                    case 1: this.updateView.setImageResource(R.drawable.rating_1); break;
                    case 2: this.updateView.setImageResource(R.drawable.rating_2); break;
                    case 3: this.updateView.setImageResource(R.drawable.rating_3); break;
                    case 4: this.updateView.setImageResource(R.drawable.rating_4); break;
                    case 5: this.updateView.setImageResource(R.drawable.rating_5); break;
                }
