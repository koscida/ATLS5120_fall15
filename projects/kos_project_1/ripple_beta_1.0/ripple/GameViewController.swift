...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if(!DataManager.fileExists()) {
            ...
            scene = GameStartScene(size: view.frame.size)
        } else {
            scene = GameInstructionsScene(size: view.frame.size)
        }
        scene = GameStartScene(size: view.frame.size)
        //scene = GameInstructionsScene(size: view.frame.size)
        //scene = GameScene(size: view.frame.size)
        //scene = GameOverScene(size: view.frame.size, newHighScore: true, score: 99)
        //scene = GameOverScene(size: view.frame.size, newHighScore: false, score: 99)
